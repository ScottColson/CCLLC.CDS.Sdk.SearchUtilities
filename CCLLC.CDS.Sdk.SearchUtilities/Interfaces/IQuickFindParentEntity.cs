...
namespace CCLLC.CDS.Sdk.Utilities.Search
{
    ...
    {
        IQuickFindParentEntity<TTarget, TParent> LinkedByField(string linkingAttribute);
        IQuickFindParentEntity<TTarget, TParent> LinkedByField(Expression<Func<TTarget, object>> anonymousTypeInitializer);
